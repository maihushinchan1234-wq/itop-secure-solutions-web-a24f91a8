...
import { Building, Home, GraduationCap, ShoppingBag, Factory, Heart, Hotel } from 'lucide-react';
...
export const HomeAutomationIndustries = () => {
  const { content } = usePageIndustries('homeautomation');
