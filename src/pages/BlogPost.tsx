            ...
            <div class="grid md:grid-cols-2 gap-4 mb-4">
              <ul class="text-blue-700 space-y-2">
                <li class="flex items-start">
                  ...
                  <span><strong>Expert Guidance:</strong> 8+ years helping customers choose the right printer</span>
                </li>
                <li class="flex items-start">
                  <CheckCircle class="h-4 w-4 text-blue-600 mt-1 mr-2 flex-shrink-0" />
                  <span><strong>Best Prices:</strong> Competitive rates with genuine products</span>
                </li>
                <li class="flex items-start">
                  <CheckCircle class="h-4 w-4 text-blue-600 mt-1 mr-2 flex-shrink-0" />
                  <span><strong>Complete Service:</strong> Sales, installation, repair, and AMC</span>
                </li>
              </ul>
              <ul class="text-blue-700 space-y-2">
                <li class="flex items-start">
                  <CheckCircle class="h-4 w-4 text-blue-600 mt-1 mr-2 flex-shrink-0" />
                  <span><strong>Quick Response:</strong> Same-day service across Delhi NCR</span>
                </li>
                <li class="flex items-start">
                  <CheckCircle class="h-4 w-4 text-blue-600 mt-1 mr-2 flex-shrink-0" />
                  <span><strong>All Brands:</strong> HP, Canon, Epson, Brother, Samsung, Xerox</span>
                </li>
                <li class="flex items-start">
                  <CheckCircle class="h-4 w-4 text-blue-600 mt-1 mr-2 flex-shrink-0" />
                  <span><strong>Warranty Support:</strong> Extended warranty and service guarantees</span>
                </li>
              </ul>
            </div>
